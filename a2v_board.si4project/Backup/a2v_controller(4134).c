...
#define HYST 10
int vibFreqGenSet(parameterA2V *dw, int running)
{
	int loudness_cmp;
	int runFlag;
...
// ------------------------------------------------------------------------
int DW_A2V_Ctrl(parameterA2V *dw, short* audioInLib,unsigned char *tuningA2V, int running)
{
	int cnt = 0;
	...
	return vibFreqGenSet(dw, running);													// set vibration amp & freq 
